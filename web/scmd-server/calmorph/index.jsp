...
<ul>
  ...
  explaines basic usage of CalMorph, all the parameters generated by CalMorph and our experimental protocols.</li>
</ul>
</td>
</tr>
</table>
...
<ol>
 ...
 <li>wait and watch status line close to run button</li>
 <li>Finish if CalMorph status is finished</li>
 <li>"data" folder on your CalMorph.jar directory contains your calculation result
  <ul>
   <li>"data/mutants": analyzed images and parameters about each cell</li>
